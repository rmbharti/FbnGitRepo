...
import com.fbn.search.controller.SearchQuery;
...
public class SearchComponent {
	...
	public List<Flight> search(SearchQuery query){
		...
		logger.info("Entering SearchComponent.search()");
		
		logger.info("Getting Origin Destination and flight date.....");
		...
		logger.info("Return Flights -" + flights.size());
		...
		logger.info("Returning result -"+searchResult.toString());
	...
	public void updateInventory(String flightNumber, String flightDate, int inventory) {
		...
		logger.info("Saving flights -" + flight.toString()); 
